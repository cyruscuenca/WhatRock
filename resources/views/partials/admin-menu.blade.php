...
<section class="settings-menu" style="width: 200pt; height: 100%; background: #424242; float: left; position: fixed;">
	<ul>
		...
		<li><p style="font-weight: bold; font-size: 15pt; margin-top: 14pt; margin-bottom: 0pt;">ADMIN AREA</p></li>
		<li><a href="{{ route('admin/index') }}">Anylitics</a></li>
		<li><a href="{{ route('admin/entries/moderate') }}">Moderate entries</a></li>
		<li><a href="{{ route('userlist') }}">Manage users</a></li>
	</ul>
</section>
