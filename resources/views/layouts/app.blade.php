...
<div class="navbar" >
      ...
      @guest
          ...
          <a class="" style="border-radius: 2px; display: inline-block; font-family: 'ubuntu-l'; color: #fff; margin-right: 54px; background: #2CBD4E; height: 30px; width: 64px; margin-top: 15px;"  href="{{ route('login') }}"><p style="padding-left: 11px; margin-top: 4.5px;">Sign in</p></a>
          </div>
      @else
      <li class="dropdown">
...
<div class="sidebar">
    <ul>
        <li id="sidebar-item-1"><img style="padding-left: 14pt;" src="{{ asset('images/home.svg') }}"><a id="sidebar-item-1-text" href="{{ url('admin') }}">Dashboard</a></li>
        <li id="sidebar-item-2"><img style="padding-left: 14pt;" src="{{ asset('images/profile.svg') }}"><a id="sidebar-item-2-text" href="{{ url('profile') }}">Profile</a></li>
        <li id="sidebar-item-3" style="margin-bottom: 5pt;"><img style="padding-left: 14pt;" src="{{ asset('images/bell.svg') }}"><a id="sidebar-item-3-text" href="{{ url('notifications') }}">Notifications</a></li>
        <div style="font-family: 'Roboto'; color: #fff; padding-left: 14pt;" class="sidebar-label">LINKS</div>
        <li id="sidebar-item-4"><img style="padding-left: 14pt;" src="{{ asset('images/wiki.svg') }}"><a id="sidebar-item-4-text" href="{{ url('wiki') }}">Wiki</a></li>
        ...
        <li id="sidebar-item-6" style="margin-bottom: 6pt;"><img style="padding-left: 16pt; padding-top: 2pt; height: 15pt;" src="{{ asset('images/edu.svg') }}"><a style="padding-top: 3pt;" id="sidebar-item-6-text" href="{{route('learn/index')}}">Learn</a></li>
        <div style=" font-family: 'Roboto'; color: #fff; padding-left: 14pt;" class="sidebar-label">TOOLS</div>
        <li id="sidebar-item-7"><img style="padding-left: 14pt;" src="{{ asset('images/id.svg') }}"><a id="sidebar-item-7-text" href="{{route('/identify/index')}}">Identify a Rock</a></li>
    </ul>
</div>
