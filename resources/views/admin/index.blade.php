...
@section('content')
	<div class="body-wrapper">
			...
			<div style="width: 100%; height: auto; display: block; margin-top: 38px; padding-left: 50px;">
				...
				<a href="{{ url('/categories/edit') }}"><button class="btn btn-primary" style="color: grey; background: #fff; border: 1px solid #ccc; margin-left: 1.3%; border-radius: 0 0 0 0; margin-top: 10px;">Edit a Category</button></a>
