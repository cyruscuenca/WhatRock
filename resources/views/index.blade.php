...
<div style="width: 100%; height: 100vh;">
	<div style="display: table; height: 100%; width: 100%; border-radius: 2px; background-image: url({{asset('images/arid-canyon-cliff-965159.jpg')}}); background-size: cover; background-position: center; text-align: center;">
	...
	<a style="margin-top: -35pt;" href="{{ route('www/index') }}">
		...
		<p style="color: #fff; font-weight: bold; font-family: 'Open Sans'; font-size: 36pt;">Undestand the World</p>
...
<div style="width: 100%; background: #E0E0E0; position: relative;">
	<div class="fixed-width" style="height: 85pt; margin-top: -34pt;">
