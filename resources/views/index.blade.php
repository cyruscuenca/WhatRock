...
<div style="width: 100%; height: 100vh;">
	<div style="display: table; height: 100%; width: 100%; background-image: url({{asset('images/landing-illustration.svg')}}); background-size: cover; background-position: bottom center; text-align: center;">
	...
	<a style="margin-top: -35pt;" href="{{ route('www/index') }}">
		...
		<p style="color: #F5F5F5; font-weight: bold; font-family: 'Open Sans'; font-size: 36pt;">Understand the World</p>
...
<div style="width: 100%; background: #757575; position: relative;">
	...
	<article>
		...
		<p>An extensive collection of landscape maps of places around the world.</p>
	</article>
	</a>
	</div>
	<div class="fixed-width" style="height: 85pt;">
		<h2 style="font-weight: bold; color: #424242; padding-top: 24pt; float: left; font-family: 'Open Sans';">Recent entries</h2>
		<a class="standard-btn" style="float: right; margin-top: 37pt; background: #424242;">MORE</a>
	</div>
