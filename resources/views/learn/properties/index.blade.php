...
<div class="body-wrapper">
	<div class="body" style="overflow-y: hidden; margin-top: calc(40px + 50px); ">
		<div class="animated fadeInUp" style="max-width: 550pt; width: 50%; margin-right: auto; margin-left: auto; background: #fff; height: 2000pt">
			<div style="padding: 12pt 16pt;">
				<p style="font-size: 25pt; color: #37474F; font-family: 'Roboto';">Properties</p> 
